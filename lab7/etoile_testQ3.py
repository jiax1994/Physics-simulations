'''ceci est un programme qui estime les parametres connues'''
...
#generer des fausses mesures sachant kep     
kep=np.array([5,0,3,0.5,0,0.7])
masse=0.85
P=np.sqrt((kep[0]**3)/masse)
t=np.linspace(0,P,12)
x,y,t=position(kep,t,masse)
sigx=x/10
sigy=y/10
#estimer un kep0 proche de kep
kep0=np.array([4.5,0,3,0.5,0,0.7])
#definir les bornes
